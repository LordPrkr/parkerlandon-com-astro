...
Recently, I've been developing a command-line JSON processor called [hson](https://github.com/LordPrkr/hson). hson is implemented in Haskell and comprises a CLI and interpreter for manipulating JSON data with the hson language.
