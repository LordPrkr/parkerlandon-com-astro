...
In my JSON processing language [hson](https://github.com/LordPrkr/hson), a program (script) is a series of variable declarations followed by an expression, as illustrated by the following type definition:
