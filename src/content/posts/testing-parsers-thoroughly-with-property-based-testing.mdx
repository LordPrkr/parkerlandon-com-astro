...
I've been implementing property-based testing for the parser of my command-line JSON processing language, [hson](https://github.com/LordPrkr/hson). Without any additional context, take a look at the following test output:
